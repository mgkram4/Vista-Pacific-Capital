  ...
  return (
    <div className="bg-white font-sans">
      <PageHeader 
        ...
        subtitle="Get the power to haul more, with financing that works for you. With specialized transportation equipment financing to fit your needs. Whether you are trying to upgrade your equipment or expand your fleet, we can make the process easy without breaking the bank."
        buttonText="Apply Now"
        buttonHref="/apply"
        backgroundImage="https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
        highlightWord="Transportation"
      />
