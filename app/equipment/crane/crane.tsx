...
export default function CraneServices() {
  ...
  return (
    <div className="bg-white font-sans">
      <PageHeader 
        title="Crane Equipment Financing"
        subtitle="Crane equipment is essential to getting the job done; we make it easier for you to get the cranes you need to lift your business to new heights. Our crane financing options offer flexible terms and quick approvals, ensuring that you can secure the right equipment without compromising your budget."
