      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4 flex flex-col items-center lg:items-start">
            <div className="transform transition-all duration-300 hover:scale-105 flex justify-center lg:justify-start w-full">
            ...
            <div className="flex justify-center lg:justify-start w-full">
              <a 
                ...
                className="inline-flex items-center justify-center w-10 h-10 bg-gradient-to-r from-[#0A66C2] to-[#0077b5] rounded-lg hover:shadow-lg hover:scale-110 transition-all duration-300"
              >
                ...
                <div key={columnIndex} className="space-y-4">
                  {column.map((category) => (
                    <Link 
                      key={category.path}
                      href={category.path}
                      className="block text-gray-300 hover:text-cyan-400 transition-colors duration-200 hover:translate-x-1 transform"
                    >
                      {category.name}
                    </Link>
                  ))}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                <div className="space-y-4">
                  {specialPages.slice(0, 3).map((page) => (
                    <Link 
                      key={page.path}
                      href={page.path}
                      className="block text-gray-300 hover:text-cyan-400 transition-colors hover:translate-x-1 transform"
                    >
                      {page.name}
                    </Link>
                  ))}
            ...
            {/* Contact Us */}
            <div className="bg-[#1D3D68] p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-6">
                <Link 
                  ...
                  className="inline-block bg-gradient-to-r from-[#FF6B35] to-[#ff825c] 
                    text-white font-medium px-6 py-3 rounded-lg shadow-md transition duration-300 
