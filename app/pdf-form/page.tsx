              ...
              <div className="flex items-start mb-4">
                ...
                <div className="ml-3 text-sm">
                  ...
                  <p className="text-gray-600 mt-1 text-xs leading-relaxed">
                    ...
                    <br /><br />
                    By submitting this form, you agree to receive occasional emails from Vista Pacific Capital regarding your application. You acknowledge you have read and agree to the Terms of Service and Privacy Policy.
                    <br /><br />
