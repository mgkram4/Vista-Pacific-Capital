...
export default function NoahPage() {
  ...
  const handleFormSubmit = () => {
    ...
    sessionStorage.setItem('teamMember', JSON.stringify(TEAM_MEMBERS.noah));
    ...
    <div className="bg-gradient-to-br from-[#113E59]/10 to-[#082F4A]/10 min-h-screen font-sans">
      ...
      <section className="w-full relative overflow-hidden">
        ...
        <div className="absolute inset-0 h-[40vh] md:h-[30vh]">
          ...
          <Image 
            src="https://images.unsplash.com/photo-1591696205602-2f950c417cb9?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3"
          ...
          <div className="max-w-6xl mx-auto px-4 w-full">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90">
                Fill out the form below to get your free finance application Finance Application and fast approval
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="lg:order-1 space-y-6 md:space-y-8 mt-10">
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-bold ml-4 text-[#113E59]">Noah Williams</h2>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 bg-[#11B5B2]/10 rounded-lg">
                  ...
                  <p className="ml-4 text-gray-700 font-medium">{TEAM_MEMBERS.noah.phone}</p>
                </div>
                <div className="flex items-center p-4 bg-[#11B5B2]/10 rounded-lg">
                  <FaEnvelope className="text-[#1E5470] text-xl" />
                  <p className="ml-4 text-gray-700 font-medium">{TEAM_MEMBERS.noah.email}</p>
                </div>
              </div>
            </motion.div>
